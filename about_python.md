...
- _Ерік Стівен Реймонд_ є автором книги «Собор і базар», а також людиною, яка ввела термін _відкритого програмного забезпечення_. Він каже, що [Python став його улюбленою мовою програмування] (http://www.python.org/about/success/esr/). Ця стаття стала справжнім натхненням моіх перших робіт з Python.
