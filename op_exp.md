...
- `^` (Побітове виключне АБО, англ."bit-wise XOR")
...
- `|` : Побітове АБО (англ."Bitwise OR")
- `^` : Побітове ВИКЛЮЧНО АБО (англ."Bitwise XOR")
- `&` : Побітове I (англ."Bitwise AND")
- `<<, >>` : Зміщеня (англ."Shifts")
...
[Двійкове число (англ."binary number")](https://en.wikipedia.org/wiki/Binary_number) - це число, виражене у двійковій системі числення, використовуючи лише два різні символи, як 0 і 1.

Щоб краще зрозуміти двійкову систему числення, давайте спочатку розглянемо більш популярну [десяткову систему числення, англ."decimal numeral system"](https://en.wikipedia.org/wiki/Decimal):
