...
--- __завершення прикладу перекладача__ ---



Приклад від Swaroop (зберегти як `module_using_sys.py`):
...
--- __Примітка від перекладача__ ---

У прикладах від Swaroop використовуються поняття  "PythonPath" і змінні середовища (англ."enviroment variables")
