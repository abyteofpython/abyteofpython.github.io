...
## Free/Libre and Open Source Software (_FLOSS_)


> ПРИМІТКА: Будь ласка, зверніть увагу, що цей розділ був написаний у 2003 році, тому деякі з них здадуться вам дивовижними :-)

[FLOSS](http://en.wikipedia.org/wiki/FLOSS) базується на концепції спільноти, в якій прийнято ділитися і обмінюватися знаннями. FLOSS безкоштовне для використання, модифікації та розповсюдження.

Якщо ви вже прочитали цю книгу, ви вже знайомі з вільним ПЗ, так як ви вивчали
Python весь цей час, а Python є вільним програмним забезпеченням!

Ось кілька прикладів вільного ПЗ, за якими можна скласти деяке уявлення про те, що здатне створити така спільнота:
...
Отже, вперед і досліджуйте величезний, вільний і відкритий світ FLOSS!
