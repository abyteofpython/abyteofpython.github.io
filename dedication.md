...
[Піонерам, які створили Інтернет]  [pioneers who made the Internet happen](http://www.ibiblio.org/pioneers/index.html). Ця книга була вперше написана в 2003 році. Вона досі залишається популярною завдяки характеру обміну знаннями в Інтернеті, як передбачали піонери.
