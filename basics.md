...
Пробіли ("Whitespace") важливі в Python. Точніше *пробіли на початку рядка важливі*. Це називається _відступами_(_"indentation"_). Передні відступи (пробіли та табуляції) на початку логічного рядка використовуються для визначення рівня відступу логічного рядка, який, у свою чергу, використовується для групування statement.
