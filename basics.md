...
Що, якби ви хотіли вказати дворядковий рядок? Одним із способів є використання рядка в потрійних лапках, як показано [раніше](#Потрійні лапки) або ви можете використати escape sequence для символу нового рядка - `\n`, щоб вказати початок нового рядка. Наприклад:  
