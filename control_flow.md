...
if здогадка == число:
    ...
    print('(хоч і не виграли ніякого призу!)')
...
Вітаємо, ви вгадали.
(хоч і не виграли ніякого призу!)
Виконано
```
...
Після виконання цього блоку *while-block* (p.118-126) знову перевіряється умова, яка в даному випадку є змінною `гра_запуститься`. Якщо вона істинна, ми знову виконуємо блок while, інакше ми продовжуємо виконувати необов’язковий блок else, а потім переходимо до наступного рядкам коду.
...
Пам’ятайте, що блок "else" необов’язковий. Якщо він присутній, він завжди виконується один раз після закінчення циклу for, якщо тільки не вказано оператора [break](#break-statement).
